...
import WatermelonJSON from "/public/Img/Avatar.json";
...
<template>
    ...
    <nav class="bg-white sticky top-0 z-50">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex rounded-2xl justify-center items-center">
                <img src="Img/Logo.svg" class="h-12" alt=" Logo" />
            ...
            <div class="flex md:order-2">
                <div v-if="canLogin">
                    <button v-if="$page.props.auth.user" :href="route('dashboard')"
                        class="text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 ">Dashboard</button>
                    <template v-else>
                        <Link :href="route('login')" type="button"
                            class="text-white bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 ">
                        Log in</Link>
                    </template>
                </div>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-dark bg-blue-700 rounded md:bg-transparent md:text-violet-700 md:p-0 "
                            aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="#about"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-violet-700 md:p-0 ">About</a>
                    </li>
                    <li>
                        <a href="#contactus"
                            class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-violet-700 md:p-0 ">Contact Us</a>
                    </li>
    ...
    <section class="bg-white light:bg-white-900">
        <div class="py-1 px-4 mx-auto max-w-screen-xl  lg:py-16 grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div data-aos="fade-right" class="flex flex-col justify-center">
                <h1
                    class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl ">{{ slider.judul }}</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl ">
                    {{ slider.konten }}</p>
                <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                    <a href="#"
                        class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-violet-700 hover:bg-violet-950 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    ...
                    <a href="#"
                        class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-violet-100 focus:ring-4 focus:bg-violet-100  ">
                        Learn more </a>
                </div>
            </div>
    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div data-aos="fade-right" class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a  href="https://www.instagram.com/_farlls/"
                            class="font-body text-lg font-semibold uppercase text-grey-20 hover:text-violet-700 "> Connect with me </a>
            ...
            <div data-aos="fade-left" class="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0">
                <div v-for="item in skill" :key="item.id">
                    ...
                    <div class="mt-2 bg-lila w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
                        <div class="bg-violet-700 h-2.5 rounded-full" style="width: {{item.konten}}%"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div id="contactus" className="mx-auto max-w-screen-xl  px-4 sm:px-6">
            <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                <div className="sm:col-span-12 lg:col-span-3">
                    ...
                    <div className="text-sm h-8 text-gray-600">
                        <img src="Img/Logo.svg" class="h-16 mr-3" alt=" Logo" />
                        <!-- <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Dosen AI</span> -->
                    </div>
                </div>
