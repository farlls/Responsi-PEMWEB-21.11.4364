                    ...
                    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                       <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr v-for="post in posts" >
                                <td class="px-6 py-4 whitespace-wrap">{{ post.id }}</td>
                                <td class="px-6 py-4 whitespace-wrap">{{ post.judul }}</td>
                                <td class="px-6 py-4 whitespace-wrap">{{ post.kategori }}</td>
                                <td class="px-6 py-4 whitespace-wrap">{{ post.konten }}</td>
                                <td class="px-6 py-4 whitespace-wrap"> {{ post.creted_at }}</td>
                                <td class="px-6 py-4 whitespace-wrap">{{ post.penulis }}</td>
